    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/playground/announcement/announceAttachment'; 	//upload URL
    	console.log("path : " +sUploadURL)
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			...
 			sUrl  : '/teamproject3/announceWrite2',
 			sCallback : '/teamproject3/annNavereditor/sample/photo_uploader/callback.html',
