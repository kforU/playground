				...
				<div class="sidebar" style="margin-top: 100px">
					...
					<div class="widget rate">
						<c:choose>
							...
							<form id="reservation-form" action="/controller/productPayment/${ product.productNo }" method="get">
							<h5 class="widget-header text-center">상품이 마음에 드십니까?</h5>
								<ul class="list-inline mt-20">
									<li class="list-inline-item"><input type="submit" class="btn btn-transparent" value="즉시구매"></li>
