				...
				<div class="sidebar" style="margin-top: 100px">
					<div class="widget disclaimer">
						<h5 class="widget-header text-center">주문 수량</h5>
								<ul>
									<li><input type="number" min="1" max="${ product.productCount }" id="count" oninput="countValue()">개 <div></div> <p id="orderCount" style="color:red;"></p> </li>
								</ul>
					</div>
					<!-- Safety tips widget -->
					<div class="widget disclaimer">
					...
					<div class="widget price text-center" >
						...
						<div class="widget disclaimer">
								<div class="row">
												...
												<form role="form">
													<div class="form-group">
														...
														<div class="input-group">
															<input type="text" class="form-control" id="cardNumber" maxlength="16" onKeyup="cardNumber();"
										...
										<br />
										<button class="btn btn-success btn-lg btn-block" type="submit">지불</button>
									</div>
								</div>
							</div>
						</div>
