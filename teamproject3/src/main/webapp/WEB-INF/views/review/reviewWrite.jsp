  	...
  	<article>
        <header class="section background-dark">
          <div class="line" style="width:900px">        
            <h1 class="Detail Page Title" style="text-align: center">후기작성</h1>
          </div>  
        </header>
       <div>
       ...
       <tr>
       <th>제목</th>
       <td><input type="text" name="reviewTitle" style="width:1100px"></td>
       </tr>
       <tr>
       <th>작성자</th>
       ...
       <tr>
       <th>내용</th>
       <td><textarea name="reviewContent" id="content" style="width:1100px" rows="17"></textarea></td>
       </tr>
       </table>
       <br>
