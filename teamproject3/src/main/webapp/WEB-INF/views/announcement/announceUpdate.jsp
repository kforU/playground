...
<section class="hero-area bg-1 text-center overly">
  ...
  <!-- content-->
  	...
  	<article>
       ...
       <div>
       <form action="${ path }/announcement/update" id="frm" method="POST" enctype="Multipart/form-data">
...
$(function() {
    ...
    $('#cancel').on('click', function(event){
    	location.href="${ path }/announcement/announceDetail/${ announcement.announcementNo }"
    })
});
 </script>
